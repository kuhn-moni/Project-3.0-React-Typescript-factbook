...
export interface Environment {
  "Environment - current issues": EnvironmentCurrentIssues;
  ...
  "Major lakes (area sq km)": MajorLakesAreaSqKm2;
  "Total water withdrawal": TotalWaterWithdrawal;
  "Total renewable water resources": TotalRenewableWaterResources;
}

export interface EnvironmentCurrentIssues {
  text: string;
}

export interface EnvironmentInternationalAgreements {
  "party to": PartyTo;
  "signed, but not ratified": SignedButNotRatified;
}
...
export interface SignedButNotRatified {
  text: string;
}

export interface Climate2 {
  text: string;
}

export interface LandUse2 {
  "agricultural land": AgriculturalLand2;
  "agricultural land: arable land": AgriculturalLandArableLand2;
  "agricultural land: permanent crops": AgriculturalLandPermanentCrops2;
  "agricultural land: permanent pasture": AgriculturalLandPermanentPasture2;
  forest: Forest2;
  other: Other2;
}

export interface AgriculturalLand2 {
  text: string;
}

export interface AgriculturalLandArableLand2 {
  text: string;
}

export interface AgriculturalLandPermanentCrops2 {
  text: string;
}

export interface AgriculturalLandPermanentPasture2 {
  text: string;
}

export interface Forest2 {
  text: string;
}
...
export interface Urbanization2 {
  "urban population": UrbanPopulation2;
  "rate of urbanization": RateOfUrbanization2;
}

export interface UrbanPopulation2 {
  text: string;
}

export interface RateOfUrbanization2 {
  text: string;
}
...
export interface AirPollutants {
  "particulate matter emissions": ParticulateMatterEmissions;
  "carbon dioxide emissions": CarbonDioxideEmissions;
  "methane emissions": MethaneEmissions;
}

export interface ParticulateMatterEmissions {
  text: string;
}
...
export interface WasteAndRecycling {
  "municipal solid waste generated annually": MunicipalSolidWasteGeneratedAnnually;
  "municipal solid waste recycled annually": MunicipalSolidWasteRecycledAnnually;
  "percent of municipal solid waste recycled": PercentOfMunicipalSolidWasteRecycled;
}

export interface MunicipalSolidWasteGeneratedAnnually {
  text: string;
}

export interface MunicipalSolidWasteRecycledAnnually {
  text: string;
}

export interface PercentOfMunicipalSolidWasteRecycled {
  text: string;
}

export interface MajorLakesAreaSqKm2 {
  "fresh water lake(s)": FreshWaterLakeS2;
}

export interface FreshWaterLakeS2 {
  text: string;
}
...
export interface TotalRenewableWaterResources {
  text: string;
}
...
export interface Energy {
  ...
  Coal: Coal;
  Petroleum: Petroleum;
  "Refined petroleum products - production": RefinedPetroleumProductsProduction;
  "Refined petroleum products - exports": RefinedPetroleumProductsExports;
  "Refined petroleum products - imports": RefinedPetroleumProductsImports;
  "Natural gas": NaturalGas;
  "Carbon dioxide emissions": CarbonDioxideEmissions2;
  "Energy consumption per capita": EnergyConsumptionPerCapita;
}

export interface ElectricityAccess {
  "electrification - total population": ElectrificationTotalPopulation;
}

export interface ElectrificationTotalPopulation {
  text: string;
}

export interface Electricity {
  "installed generating capacity": InstalledGeneratingCapacity;
  consumption: Consumption;
  exports: Exports2;
  imports: Imports2;
  "transmission/distribution losses": TransmissionDistributionLosses;
}

export interface InstalledGeneratingCapacity {
  text: string;
}
...
export interface Exports2 {
  text: string;
}

export interface Imports2 {
  text: string;
}

export interface TransmissionDistributionLosses {
  text: string;
}
...
export interface ElectricityGenerationSources {
  ...
  "tide and wave": TideAndWave;
  geothermal: Geothermal;
  "biomass and waste": BiomassAndWaste;
}

export interface FossilFuels {
  text: string;
}
...
export interface Hydroelectricity {
  text: string;
}

export interface TideAndWave {
  text: string;
}

export interface Geothermal {
  text: string;
}

export interface BiomassAndWaste {
  text: string;
}

export interface NuclearEnergy {
  "Number of operational nuclear reactors": NumberOfOperationalNuclearReactors;
  "Number of nuclear reactors under construction": NumberOfNuclearReactorsUnderConstruction;
  "Net capacity of operational nuclear reactors": NetCapacityOfOperationalNuclearReactors;
  "Percent of total electricity production": PercentOfTotalElectricityProduction;
  "Percent of total energy produced": PercentOfTotalEnergyProduced;
  "Number of nuclear reactors permanently shut down": NumberOfNuclearReactorsPermanentlyShutDown;
}

export interface NumberOfOperationalNuclearReactors {
  text: string;
}

export interface NumberOfNuclearReactorsUnderConstruction {
  text: string;
}

export interface NetCapacityOfOperationalNuclearReactors {
  text: string;
}

export interface PercentOfTotalElectricityProduction {
  text: string;
}

export interface PercentOfTotalEnergyProduced {
  text: string;
}

export interface NumberOfNuclearReactorsPermanentlyShutDown {
  text: string;
}
...
export interface Coal {
  ...
  exports: Exports3;
  imports: Imports3;
  "proven reserves": ProvenReserves;
}
...
export interface Exports3 {
  text: string;
}

export interface Imports3 {
  text: string;
}

export interface ProvenReserves {
  text: string;
}

export interface Petroleum {
  "total petroleum production": TotalPetroleumProduction;
  "refined petroleum consumption": RefinedPetroleumConsumption;
  "crude oil and lease condensate exports": CrudeOilAndLeaseCondensateExports;
  "crude oil and lease condensate imports": CrudeOilAndLeaseCondensateImports;
  "crude oil estimated reserves": CrudeOilEstimatedReserves;
}

export interface TotalPetroleumProduction {
  text: string;
}

export interface RefinedPetroleumConsumption {
  text: string;
}

export interface CrudeOilAndLeaseCondensateExports {
  text: string;
}

export interface CrudeOilAndLeaseCondensateImports {
  text: string;
}

export interface CrudeOilEstimatedReserves {
  text: string;
}

export interface RefinedPetroleumProductsProduction {
  text: string;
}

export interface RefinedPetroleumProductsExports {
  text: string;
}

export interface RefinedPetroleumProductsImports {
  text: string;
}
...
export interface NaturalGas {
  ...
  exports: Exports4;
  imports: Imports4;
  "proven reserves": ProvenReserves2;
  note: string;
}
...
export interface Consumption3 {
  text: string;
}

export interface Exports4 {
  text: string;
}

export interface Imports4 {
  text: string;
}

export interface ProvenReserves2 {
  text: string;
}

export interface CarbonDioxideEmissions2 {
  "total emissions": TotalEmissions;
  "from coal and metallurgical coke": FromCoalAndMetallurgicalCoke;
  "from petroleum and other liquids": FromPetroleumAndOtherLiquids;
  "from consumed natural gas": FromConsumedNaturalGas;
}
...
export interface FromCoalAndMetallurgicalCoke {
  text: string;
}

export interface FromPetroleumAndOtherLiquids {
  text: string;
}

export interface FromConsumedNaturalGas {
  text: string;
}

export interface EnergyConsumptionPerCapita {
  "Total energy consumption per capita 2019": TotalEnergyConsumptionPerCapita2019;
}

export interface TotalEnergyConsumptionPerCapita2019 {
  text: string;
}
...
export interface Transportation {
  ...
  "Civil aircraft registration country code prefix": CivilAircraftRegistrationCountryCodePrefix;
  Airports: Airports;
  ...
  "Transportation - note": TransportationNote;
}

export interface NationalAirTransportSystem {
  "number of registered air carriers": NumberOfRegisteredAirCarriers;
  "inventory of registered aircraft operated by air carriers": InventoryOfRegisteredAircraftOperatedByAirCarriers;
  "annual passenger traffic on registered air carriers": AnnualPassengerTrafficOnRegisteredAirCarriers;
  "annual freight traffic on registered air carriers": AnnualFreightTrafficOnRegisteredAirCarriers;
}

export interface NumberOfRegisteredAirCarriers {
  text: string;
}

export interface InventoryOfRegisteredAircraftOperatedByAirCarriers {
  text: string;
}

export interface AnnualPassengerTrafficOnRegisteredAirCarriers {
  text: string;
}

export interface AnnualFreightTrafficOnRegisteredAirCarriers {
  text: string;
}

export interface CivilAircraftRegistrationCountryCodePrefix {
  text: string;
}
...
export interface Railways {
  total: Total12;
  "standard gauge": StandardGauge;
  "narrow gauge": NarrowGauge;
  "dual gauge": DualGauge;
  note: string;
}
...
export interface NarrowGauge {
  text: string;
}

export interface DualGauge {
  text: string;
}
...
export interface PortsAndTerminals {
  "major seaport(s)": MajorSeaportS;
  "container port(s) (TEUs)": ContainerPortSTeus;
  "LNG terminal(s) (import)": LngTerminalSImport;
  note: string;
}

export interface MajorSeaportS {
  text: string;
}

export interface ContainerPortSTeus {
  text: string;
}

export interface LngTerminalSImport {
  text: string;
}
